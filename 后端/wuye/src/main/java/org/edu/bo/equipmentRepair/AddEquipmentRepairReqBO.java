...
public class AddEquipmentRepairReqBO {
    ...
    public String toString() {
        return "AddEquipmentRepairReqBO{" +
                "equRepairName='" + equRepairName + '\'' +
                ", equRepairAddr='" + equRepairAddr + '\'' +
                ", equRepairDate=" + equRepairDate +
                ", status='" + status + '\'' +
                ", note='" + note + '\'' +
                ", equRepairPerson='" + equRepairPerson + '\'' +
                '}';
    }
}
